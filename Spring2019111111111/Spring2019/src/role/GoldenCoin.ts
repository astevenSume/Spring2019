class GoldenCoin extends Enemy{
	...
	public onStatus(ps:PlayScene, emy:Enemy) {
		//上跳金币数字
		let add_score_label = new eui.Label()
		let scores:number = emy.val
		...
		if (ps.nagetive_status[Ns.SkullCoin] == true)scores = 0
	...
	private showSurpass(ps: PlayScene) {
