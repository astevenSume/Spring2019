...
var RankScene = (function (_super) {
    ...
    RankScene.prototype.currectIndexShow = function (str_data) {
    ...
    RankScene.prototype.clickDateButton = function (evt) {
        var obj = evt.target;
        //初始状态
    ...
    RankScene.prototype.getRecords = function (uid) {
        var _this = this;
        //获取最高记录
    ...
    RankScene.prototype.childrenCreated = function () {
        ...
        var today_obj = eval("this.l_date_" + this.today_key);
        today_obj.text = '今日';
    ...
    RankScene.prototype.postComplete = function (data, obj) {
        if (data == 'no_data') {
        }
        else {
            obj.init_data(data);
    ...
    RankScene.prototype.init_data = function (data) {
        var _this = this;
        var res = JSON.parse(data);
