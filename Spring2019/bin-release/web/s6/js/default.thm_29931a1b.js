window.skins={};
	...
	function RankSceneSkin() {
		_super.call(this);
		this.skinParts = ["records_list","group_score","title_img","no_data_group","title_group","l_date_1","g_date_1","l_date_2","g_date_2","l_date_3","g_date_3","l_date_4","g_date_4","l_date_5","g_date_5","l_date_6","g_date_6","l_date_7","g_date_7","group_date","my_index","real_name","cu_date","rank_score","rimg_avatar","rinf_group","rbtn_close"];
		
		this.height = 667;
		this.width = 375;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.group_score_i(),this.title_img_i(),this.no_data_group_i(),this.title_group_i(),this.group_date_i(),this.rinf_group_i(),this.rbtn_close_i()];
	}
	...
	_proto.rinf_group_i = function () {
		...
		t.top = 83;
		t.width = 330;
		t.elementsContent = [this._Image4_i(),this.my_index_i(),this._Label5_i(),this.real_name_i(),this.cu_date_i(),this._Image5_i(),this.rank_score_i(),this._Button1_i(),this.rimg_avatar_i(),this._Label6_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
